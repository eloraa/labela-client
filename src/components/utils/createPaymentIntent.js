...
const stripe = Stripe(import.meta.env.VITE_STRIPESECRETAPIKEY)

export const createPaymentIntent = async (paymentMethodType, currency, email, amount, paymentMethodOptions) => {
    ...
    if(paymentMethodType === 'acss_debit') {
      ...
      params.confirm = true
      params.customer = await stripe.customers.create().then(data => data.id)
    }
