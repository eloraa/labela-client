      ...
      <div className="lg:col-span-2">
        <div className="md:px-10 px-5">
          ...
          <form onSubmit={handleFormSubmit} className="mt-6 grid gap-4">
            ...
            <div className="w-full">
              <input onChange={validatePassword} className="w-full py-4 outline-none border-2 px-6 rounded focus:border-black" type="password" name="password" placeholder="Password" required />
            </div>
            <div>
            ...
            <div className="w-full md:grid grid-cols-2 gap-3 pt-6 border-t">
              ...
              <button className="bg-black w-full max-md:mt-6 py-2.5 md:px-24 px-0 text-white font-bold rounded active:scale-[.99] transition-transform text-sm">Sign Up</button>
            </div>
